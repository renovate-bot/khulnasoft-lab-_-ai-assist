...
@pytest.mark.parametrize(
    "test_content,expected_output", [
        ...
        ("test 1:2:3:4:5:6:7:8", [Detected(start=5, end=20, val="1:2:3:4:5:6:7:8")]),
        ("test 1::, 1:2:3:4:5:6:7::", [
            Detected(start=5, end=8, val="1::"),
            Detected(start=10, end=25, val="1:2:3:4:5:6:7::")
        ]),
        ("test 1::8, 1:2:3:4:5:6::8, 1:2:3:4:5:6::8", [
            Detected(start=5, end=9, val="1::8"),
            Detected(start=11, end=25, val="1:2:3:4:5:6::8"),
            Detected(start=27, end=41, val="1:2:3:4:5:6::8")
        ]),
        ("test 1::7:8, 1:2:3:4:5::7:8, 1:2:3:4:5::8", [
            Detected(start=5, end=11, val="1::7:8"),
            Detected(start=13, end=27, val="1:2:3:4:5::7:8"),
            Detected(start=29, end=41, val="1:2:3:4:5::8")
        ]),
        ("test 1::6:7:8, 1:2:3:4::6:7:8, 1:2:3:4::8", [
            Detected(start=5, end=13, val="1::6:7:8"),
            Detected(start=15, end=29, val="1:2:3:4::6:7:8"),
            Detected(start=31, end=41, val="1:2:3:4::8")
        ]),
        ("test 1::5:6:7:8, 1:2:3::5:6:7:8, 1:2:3::8", [
            Detected(start=5, end=15, val="1::5:6:7:8"),
            Detected(start=17, end=31, val="1:2:3::5:6:7:8"),
            Detected(start=33, end=41, val="1:2:3::8")
        ]),
        ("test 1::4:5:6:7:8, 1:2::4:5:6:7:8, 1:2::8", [
            Detected(start=5, end=17, val="1::4:5:6:7:8"),
            Detected(start=19, end=33, val="1:2::4:5:6:7:8"),
            Detected(start=35, end=41, val="1:2::8")
        ]),
        ("test 1::3:4:5:6:7:8, 1::3:4:5:6:7:8, 1::8", [
            Detected(start=5, end=19, val="1::3:4:5:6:7:8"),
            Detected(start=21, end=35, val="1::3:4:5:6:7:8"),
            Detected(start=37, end=41, val="1::8")
        ]),
        ("test ::2:3:4:5:6:7:8, ::2:3:4:5:6:7:8, ::8, ::", [
            Detected(start=5, end=20, val="::2:3:4:5:6:7:8"),
            Detected(start=22, end=37, val="::2:3:4:5:6:7:8"),
            Detected(start=39, end=42, val="::8"),
            Detected(start=44, end=46, val="::")
        ]),
        ("test fe80::7:8%eth0, fe80::7:8%1", [
            Detected(start=5, end=19, val="fe80::7:8%eth0"),
            Detected(start=21, end=32, val="fe80::7:8%1")
        ]),
        ("test ::255.255.255.255, ::ffff:255.255.255.255, ::ffff:0:255.255.255.255", [
            Detected(start=5, end=22, val="::255.255.255.255"),
            Detected(start=24, end=46, val="::ffff:255.255.255.255"),
            Detected(start=48, end=72, val="::ffff:0:255.255.255.255")
        ]),
        ("test 2001:db8:3:4::192.0.2.33, 64:ff9b::192.0.2.33", [
            Detected(start=5, end=29, val="2001:db8:3:4::192.0.2.33"),
            Detected(start=31, end=50, val="64:ff9b::192.0.2.33")
        ]),
    ]
)
